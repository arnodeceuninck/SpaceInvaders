...
spaceinvaders::event::EntityCreatedEvent::EntityCreatedEvent(
        std::shared_ptr<spaceinvaders::model::EntityModel> entity) : entity(std::move(entity)) {}
...
spaceinvaders::event::EntityCreatedEvent::EntityCreatedEvent(
        std::shared_ptr<spaceinvaders::model::EntityModel> entity, std::string prefferedSprite) : entity(std::move(
        entity)), prefferedSprite(std::move(prefferedSprite)) {}
